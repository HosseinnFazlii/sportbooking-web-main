...
import { styled, useTheme, useScrollTrigger, AppBar as MuiAppBar, AppBarProps, Toolbar as MuiToolbar, ToolbarProps } from '../../../foundations';
import { hexToRGBA } from '../../../utils';
import { HandleSaveSettingsType, HandleVoidType, NavContentType, Settings } from '../../types';

interface ILayoutAppBar {
    hidden: boolean;
    settings: Settings;
    appBarProps?: AppBarProps;
    saveSettings: HandleSaveSettingsType;
    toggleNavVisibility: HandleVoidType;
    appBarContent?: NavContentType;
}
...
export const LayoutAppBar: FC<ILayoutAppBar> = (props) => {
