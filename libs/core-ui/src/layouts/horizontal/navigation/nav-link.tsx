...
import { Box, Chip, List, styled, Typography, ListItemIcon, ListItemProps, ListItem as MuiListItem } from '../../../foundations';
import { themeConfig } from '../../../configs';
import { INavLink, Settings } from '../../types';
import { Icon, Translation, CanViewNavLink, Link } from '../../../components';
import { hexToRGBA, handleURLQueries } from '../../../utils';

interface IHorizontalNavLink {
  item: INavLink;
  settings: Settings;
  hasParent?: boolean;
}
...
export const HorizontalNavLink: FC<IHorizontalNavLink> = ({ item, settings, hasParent }) => {
