import { useEffect, useCallback, useRef, useState, ChangeEvent, FC } from 'react';
import { useRouter } from 'next/router';
import axios from 'axios';
import { Box, Grid, List, Dialog as MuiDialog, ListItem, TextField, Typography, IconButton, useMediaQuery, styled, useTheme, ListItemButton, InputAdornment, Autocomplete as MuiAutocomplete, AutocompleteRenderInputParams } from "../../foundations";
...
export const AppbarAutocomplete: FC<IAppbarAutocomplete> = ({ hidden, settings }) => {
