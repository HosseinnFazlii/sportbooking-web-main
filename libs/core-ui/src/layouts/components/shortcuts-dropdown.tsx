...
import { Box, Grid, Divider, Tooltip, IconButton, Typography, styled, Theme, useMediaQuery, Menu as MuiMenu, MenuProps, MenuItem as MuiMenuItem, MenuItemProps } from '../../foundations';
import { Icon, CustomAvatar, Link } from '../../components';
...
export const ShortcutsDropdown: FC<IShortcutsDropdown> = ({ shortcuts, settings }) => {
