import { useState, SyntheticEvent, Fragment, ReactNode, FC } from 'react';
// import PerfectScrollbarComponent from 'react-perfect-scrollbar'
import { Box, Badge, Button, IconButton, styled, Theme, useMediaQuery, Menu as MuiMenu, MenuProps, MenuItem as MuiMenuItem, MenuItemProps, Typography, TypographyProps } from '../../../foundations';
import { getInitials } from '../../../utils';
import { ThemeColorType } from '../../../layouts';
import { Settings } from '../../../contexts';
import { Icon, CustomAvatarProps, CustomChip, CustomAvatar } from "../../atoms";
...
const ScrollWrapper = ({ children, hidden }: { children: ReactNode; hidden: boolean }) => {
  if (hidden) {
    ...
    return children; // <PerfectScrollbar options={{ wheelPropagation: false, suppressScrollX: true }}>{children}</PerfectScrollbar>
  }
}

export const NotificationDropdown: FC<INotificationDropdown> = ({ settings, notifications }) => {
