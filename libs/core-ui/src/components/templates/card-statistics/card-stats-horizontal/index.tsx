import { Box, Card, styled, Typography, CardContent, Avatar as MuiAvatar, AvatarProps } from '../../../../foundations';
...
export const CardStatsHorizontal = (props: CardStatsHorizontalProps) => {
  // ** Props
